...
The results the reader may find missing in this chapter are likely
already part of \verb|mathlib|. Some statements may have an
``unusually formal'' formulation. The reason is that we try to keep
the blueprint as similar as possible to the code. The blueprint is a
compromise between the Lean code and the informal human maths.
...
that an Archimedean vector lattice of rank at least two necessarily has
vectors which are neither positive nor negative.

\subsection{Lattice-ordered abelian groups}

Throughout this subsection $X$ denotes an additive abelian group equipped
with a lattice order compatible with addition (an
\emph{$\ell$-group}). We write $x^+ := x \sqcup 0$, $x^- := (-x) \sqcup 0$
and $\lvert x \rvert := x \sqcup (-x)$.
...
$u, v \in X$ satisfy $x = u - v$ and $u \sqcap v = 0$. Then $u = x^+$.
\end{lemma}
...
$x \sqcap (a + b) \le x \sqcap a + x \sqcap b.$
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group, let $A \subseteq X$ and
$a, x \in X$. If $a = \sup A$, then
$x \sqcap a = \sup \{x \sqcap z : z \in A\}$.
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group, let $A \subseteq X$ and
$a, x \in X$. If $a = \inf A$, then
$x \sqcup a = \inf \{x \sqcup z : z \in A\}$.
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group, let $A, B \subseteq X$ and
$a, b \in X$. If $a = \inf A$ and $b = \inf B$, then
$a \sqcup b = \inf \{p \sqcup q : p \in A,\ q \in B\}$.
\end{lemma}
...
$a = \inf A$ and $b = \inf B$, then $a \sqcap b = \inf (A \cup B)$.
\end{lemma}
...
$\lambda \cdot (x \sqcup y) = (\lambda x) \sqcup (\lambda y).$
\end{lemma}
...
Let $X$ be a vector lattice, let $x, y \in X$ and let $\lambda \in
\mathbb{R}$ with $\lambda \ge 0$. Then
$\lambda \cdot (x \sqcap y) = (\lambda x) \sqcap (\lambda y).$
\end{lemma}
...
$(\alpha \sqcup \beta) \cdot x = (\alpha x) \sqcup (\beta x).$
\end{lemma}
...
Let $X$ be a vector lattice, let $x \in X$ with $0 \le x$ and let
$\alpha, \beta \in \mathbb{R}$. Then
$(\alpha \sqcap \beta) \cdot x = (\alpha x) \sqcap (\beta x).$
\end{lemma}
...
Let $X$ be a vector lattice, let $x, y \in X$ with $x \sqcap y = 0$ and
...
$\lvert y_i \rvert \le \lvert x \rvert \sqcap v_i$ for every $i$.
\end{theorem}
...
consequences: the lattice operations $\sqcup$, $\sqcap$ and
...
\leanok
\uses{def:normed-vector-lattice}
Let $X$ be a normed vector lattice. The map $(x, y) \mapsto x \sqcup y$
...
\leanok
\uses{def:normed-vector-lattice}
Let $X$ be a normed vector lattice. The map $(x, y) \mapsto x \sqcap y$
from $X \times X$ to $X$ is continuous.
\end{theorem}
...
$x \in [a, b]$. Then $\lVert x \rVert \le \lVert \lvert a \rvert \sqcup
\lvert b \rvert \rVert$.
\end{lemma}
...
$x$ and $y$ are \emph{disjoint} when $\lvert x \rvert \sqcap \lvert y
\rvert = 0$.
\end{definition}
...
\uses{def:isVLDisjoint}
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$ with
$0 \le x$ and $0 \le y$. If $x$ and $y$ are disjoint, then $x \sqcap y
= 0$.
\end{lemma}
...
\uses{def:isVLDisjoint}
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$ with
$x \sqcap y = 0$. Then $x$ and $y$ are disjoint.
\end{lemma}
...
\uses{def:isVLDisjoint}
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$ with
$0 \le x$, $0 \le y$ and $x$, $y$ disjoint. Then $\lvert x \sqcup y
\rvert = \lvert x \rvert \sqcup \lvert y \rvert$.
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$ with
$0 \le x$, $0 \le y$ and $x$, $y$ disjoint. Then $x + y = x \sqcup y$.
\end{lemma}
...
\uses{def:isVLDisjoint}
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$ be
disjoint. Then $\lvert x \rvert \sqcup \lvert y \rvert = \lvert x \rvert
+ \lvert y \rvert$.
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$ be
disjoint. Then $\lvert x + y \rvert = \lvert x \rvert \sqcup \lvert y
\rvert$.
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group and let $x, y, z \in X$. If
$x$ and $z$ are disjoint and $y$ and $z$ are disjoint, then $x \sqcup y$
and $z$ are disjoint.
\end{lemma}
...
Let $X$ be a lattice-ordered abelian group and let $x, y \in X$. Then
$x - x \sqcap y$ and $y - x \sqcap y$ are disjoint.
\end{lemma}
...
$\alpha : \{0, \dots, n-1\} \to \mathbb{R}$,
$\sum_i \alpha_i x_i = \bigsqcup_i \alpha_i x_i$.
\end{theorem}
